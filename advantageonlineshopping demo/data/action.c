Action()
{
	...
	web_custom_request("collect", 
		"URL=https://www.google-analytics.com/j/collect?v=1&_v=j101&a=285952135&t=pageview&_s=1&dl=https%3A%2F%2Fadvantageonlineshopping.com%2F&dp=%2F&ul=en-us&de=UTF-8&dt=%C2%A0Advantage%20Shopping&sd=24-bit&sr=1366x768&vp=1366x641&je=0&_u=IEBAAEABAAAAACAAI~&jid=1885753440&gjid=688667536&cid=56093117.1704386070&tid=UA-81334227-1&_gid=1368696169.1704386070&_r=1&_slc=1&z=859926269", 
		"Method=POST", 
		"Resource=0", 
	...
	web_submit_data("414141", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=sessionId", "Value=432EB46DFCE6FD68A4FA6B8CCAFA3248", ENDITEM, 
		LAST);
	...
	web_custom_request("shippingcost", 
		...
		"Mode=HTML", 
		"EncType=application/json;charset=UTF-8", 
		"Body={\"seaddress\":{\"addressLine1\":\"abc\",\"addressLine2\":\"\",\"city\":\"hyderabad\",\"country\":\"in\",\"postalCode\":12345,\"state\":\"telangana\"},\"secustomerName\":\"user name\",\"secustomerPhone\":1234567890,\"senumberOfProducts\":2,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"432EB46DFCE6FD68A4FA6B8CCAFA3248\"}", 
		LAST);
